...
class Aurora(commands.Cog):
    ...
    async def cog_check(self, ctx):
        ...
        if aurora not in ctx.author.roles:
            ...
            return
        return (
            aurora in ctx.author.roles
            or ctx.message.author.guild_permissions.administrator is True
        )
    ...
    async def base_percentage(ctx, inter, base_percentage, source):
        ...
        if base_percentage < 0.01:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Base percentage is too low!",
                fields=None,
                footer_text="The minimum base percentage is 0.01.",
                status="alert",
            )
        ...
        if base_percentage > 10.00:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Base percentage is too high!",
                fields=None,
                footer_text="The maximum base percentage is 10.00.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET base_percentage = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated base percentage to \
{base_percentage}.""",
            fields=None,
            footer_text=f"""Each message will grant a base {base_percentage}% of the experience required for the next \
level, before multipliers.""",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
...
characters.""",
        ...
        if multiplier < 0.01:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Multiplier is too low!",
                fields=None,
        ...
        if multiplier > 10.00:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Multiplier is too high!",
                fields=None,
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT channel_multipliers FROM server_config WHERE guild_id = ?",
            [src.guild.id],
        )
        ...
        cur.execute(
            "UPDATE server_config SET channel_multipliers = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated the experience multiplier for {channel.mention} to {multiplier}.""",
            fields=None,
    ...
    async def character_limit(ctx, inter, character_limit, source):
        ...
        if character_limit < 1:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Character limit is too low!",
                fields=None,
                footer_text="""This bot can support a minimum of 1 character per player per server.""",
                status="alert",
            )
            return
        if character_limit > 10:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Character limit is too high!",
                fields=None,
                footer_text="""This bot can support a maximum of 10 characters per player per server.""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET character_limit = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated character limit to {character_limit}.""",
            fields=None,
            footer_text="""This bot can support a maximum of 10 characters per player per server.""",
            status="success",
        )
    ...
    async def dm_choose(ctx, inter, source):
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT dm_choose FROM server_config WHERE guild_id = ?", [src.guild.id]
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        dm_choose = None
        if int(server_config["dm_choose"]) == 1:
            ...
            dm_choose = 1
        cur.execute(
            "UPDATE server_config SET dm_choose = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"Updated DM choose to {dm_choose}.",
            fields=None,
            footer_text="""If DM choose is 1, DMs can set the DM tag for the character they prefer to get \
experience.""",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
    ...
    async def dm_role(ctx, inter, role, source):
        ...
        if role.guild != src.guild:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="That is not a role in this server!",
                fields=None,
                footer_text="Please select a role from this server.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        if len(role.name) > 50:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Role name too long!",
                fields=None,
                footer_text="""For technical reasons, please only select roles with names that are less than 50 \
characters.""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT dm_roles FROM server_config WHERE guild_id = ?", [src.guild.id]
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        con.close()
            ...
            if role_in_list.id == role.id:
                ...
                selects = view.add_item(
                    disnake.ui.StringSelect(
                        placeholder="Select which role(s) to remove.",
                        options=[],
                        min_values=1,
                        max_values=1,
                    )
                ...
                selects.children[0].add_option(
                    ...
                    value=current_role.id,
                    description=f"""This option will remove {current_role.name} from this server's list of DM roles.""",
                )
                for role_in_list_ in role_list:
                    ...
                    if role_in_list_.id != current_role.id:
                        selects.children[0].add_option(
                            label=role_in_list_.name,
                            value=role_in_list_.id,
                            description=f"""This option will remove {role_in_list_.name} from this server's list of DM \
roles.""",
                        )
                view = MultiSelection(
                    src=src,
                ...
                await EmbedBuilder.embed_builder(
                    ...
                    custom_thumbnail=None,
                    custom_title=None,
                    description=f"""Unassign {role.name} as a DM role on this server?""",
                    fields=None,
                    footer_text="You may also select other DM roles to remove.",
                    status="unsure",
                )
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET dm_roles = ? WHERE guild_id = ?",
            [roles, src.guild.id],
        )
        con.commit()
        con.close()
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description="Updated the DM roles list.",
            fields=None,
            footer_text="""If DM choose is on, DM roles can set the DM tag on one of their characters for a boost to \
experience determination likelihood.""",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
    ...
    async def experience_threshold(ctx, inter, level, experience, source):
        ...
        if level < 1:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Level is too low!",
                fields=None,
                footer_text=f"""The level you are attempting to edit is below the minimum level.""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        if experience > 999999999:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Experience required is too high!",
                fields=None,
                footer_text=f"""The maximum experience needed for a threshold is 999,999,999.""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT maximum_level, experience_thresholds FROM server_config WHERE guild_id = ?",
            [src.guild.id],
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        con.close()
        ...
        if experience < int(thresholds[f"{level - 1}"]):
            await EmbedBuilder.embed_builder(
                ...
                fields=None,
                footer_text=f"""The threshold you are attempting to set is below the amount needed for level \
{level - 1} ({thresholds[f"{level - 1}"]}).""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        if level > int(server_config["maximum_level"]):
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Level is too high!",
                fields=None,
                footer_text=f"""The level you are attempting to edit exceeds the maximum level for this server \
({server_config["maximum_level"]}).""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        if level < int(server_config["maximum_level"]):
            if experience >= int(thresholds[f"{level + 1}"]):
                await EmbedBuilder.embed_builder(
                    ...
                    custom_thumbnail=None,
                    custom_title=None,
                    description="""Experience threshold is too high!""",
                    fields=None,
                    footer_text=f"""The threshold for level {level + 1} is {thresholds[f"{level + 1}"]}.""",
                    status="alert",
                )
                return
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET experience_thresholds = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated the experience threshold for level {level} to {experience}.""",
            fields=None,
            footer_text=f"Players now need {experience} experience to hit level {level}.",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
...
characters.""",
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT ignored_channels FROM server_config WHERE guild_id = ?",
            [src.guild.id],
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        con.close()
        for channel_in_list in json.loads(server_config["ignored_channels"]):
            channel_in_list = disnake.utils.get(
                src.guild.channels, id=int(channel_in_list)
            )
            if channel_in_list.id == channel.id:
                ...
                selects.children[0].add_option(
                    ...
                    description=f"""This option will remove {current_channel.name} from this server's list of ignored \
channels.""",
                )
                for channel_in_list_ in channel_list:
                    ...
                    if channel_in_list_.id != current_channel.id:
                        selects.children[0].add_option(
                            label=channel_in_list_.name,
                            value=channel_in_list_.id,
                            description=f"""This option will remove {channel_in_list_.name} from this server's list of \
ignored channels.""",
                        )
                view = MultiSelection(
                    src=src,
                ...
                await EmbedBuilder.embed_builder(
                    ...
                    custom_thumbnail=None,
                    custom_title=None,
                    description=f"""Unassign {channel.mention} as an ignored channel on this server?""",
                    fields=None,
                    footer_text="You may also select other ignored channels to remove.",
                    status="unsure",
                )
                await response.edit(content=None, embed=EmbedBuilder.embed, view=view)
                timeout = await view.wait()
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET ignored_channels = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description="Updated the ignored channels list.",
            fields=None,
...
characters.""",
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT ignored_roles FROM server_config WHERE guild_id = ?", [src.guild.id]
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        con.close()
        for role_in_list in json.loads(server_config["ignored_roles"]):
            ...
            if role_in_list.id == role.id:
                ...
                selects.children[0].add_option(
                    label=current_role.name,
                    value=current_role.id,
                    description=f"""This option will remove {current_role.name} from this server's list of ignored \
roles.""",
                )
                for role_in_list_ in role_list:
                    if len(selects.children[0].options) > 20:
                    ...
                    if role_in_list_.id != current_role.id:
                        selects.children[0].add_option(
                            label=role_in_list_.name,
                            value=role_in_list_.id,
                            description=f"""This option will remove {role_in_list_.name} from this server's list of \
ignored roles.""",
                        )
                view = MultiSelection(
                    src=src,
                ...
                await EmbedBuilder.embed_builder(
                    ...
                    custom_thumbnail=None,
                    custom_title=None,
                    description=f"""Unassign {role.name} as an ignored role on this server?""",
                    fields=None,
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET ignored_roles = ? WHERE guild_id = ?",
            [roles, src.guild.id],
        )
        con.commit()
        con.close()
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description="Updated the ignored roles list.",
            fields=None,
...
characters.""",
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT level_channel FROM server_config WHERE guild_id = ?", [src.guild.id]
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        con.close()
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET level_channel = ? WHERE guild_id = ?",
        ...
        if channel_id == 0:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Level channel unset.",
                fields=None,
                footer_text="Please feel free to set a new level channel.",
                status="success",
            )
        else:
            await EmbedBuilder.embed_builder(
    ...
    async def level_message(ctx, inter, message, source):
        ...
        if len(message) > 1024:
            await EmbedBuilder.embed_builder(
                ...
                fields=None,
                footer_text="""The maximum length of the level-up message is 1024 characters.""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET level_message = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            fields=None,
            footer_text="""%PING, %CHAR, and %LVL will be substituted with a member ping, the character name, and the \
level of the respective member/character.""",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
    ...
    async def level_multiplier(ctx, inter, level, multiplier, source):
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT maximum_level, level_multipliers FROM server_config WHERE guild_id = ?",
            [src.guild.id],
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        con.close()
...
({server_config["maximum_level"]}).""",
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET level_multipliers = ? WHERE guild_id = ?",
            [multipliers, src.guild.id],
        )
        con.commit()
        con.close()
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated the experience multiplier for level {level} to {multiplier}.""",
            fields=None,
            footer_text="A multiplier of 1.00 has no impact on the experience formula.",
            status="success",
        )
    ...
    async def max_wiggle(ctx, inter, max_wiggle, source):
        ...
        if max_wiggle < 0.01:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Maximum wiggle is too low!",
                fields=None,
                footer_text="The minimum maximum wiggle is 0.01.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        if max_wiggle > 5.00:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Maximum wiggle is too high!",
                fields=None,
                footer_text="The maximum maximum wiggle is 5.00.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET max_wiggle = ? WHERE guild_id = ?",
            [max_wiggle, src.guild.id],
        )
        con.commit()
        cur.execute(
            "SELECT min_wiggle, max_wiggle FROM server_config WHERE guild_id = ?",
            [src.guild.id],
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        con.close()
    ...
    async def maximum_level(ctx, inter, maximum_level, source):
        ...
        if maximum_level < 1:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Maximum level is too low!",
                fields=None,
                footer_text="The minimum maximum level is 1.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        if maximum_level > 100:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Maximum level is too high!",
                fields=None,
                footer_text="The maximum maximum level is 100.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            """SELECT experience_thresholds FROM server_config WHERE guild_id = ?""",
            [src.guild.id],
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        con.close()
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET maximum_level = ?, experience_thresholds = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"Updated maximum level to {maximum_level}.",
            fields=None,
            footer_text="""Set the threshold of every level between the old and new maximum level to be one higher \
than each previous.\nPlease do not forget to update the thresholds!""",
    ...
    @staticmethod
    async def mod_experience(
        ctx, inter, player, character_name, operator, amount, source
    ):
        src = None
        if source == "slash":
            src = inter
        ...
        if amount > 999999998:
            await EmbedBuilder.embed_builder(
                ...
                fields=None,
                footer_text="""The maximum amount that experience can be modified by is 999,999,998.""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT character_name, player_id, experience FROM characters WHERE player_id = ? AND guild_id = ?",
        ...
        if not characters:
            await EmbedBuilder.embed_builder(
                ...
                fields=None,
                footer_text="Cannot modify experience.",
                status="unsure",
            )
        ...
        for character in characters:
            ...
            await EmbedBuilder.embed_builder(
                ...
                fields=None,
                footer_text="Don't forget to surround the name in quotes.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        if operator == "+" and int(character["experience"]) + amount > 999999998:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Experience is too high!",
                fields=None,
                footer_text="""The maximum amount of experience after modification is 999,999,998.""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
            ...
            await EmbedBuilder.embed_builder(
                ...
                description="Experience is too low!",
                fields=None,
                footer_text="""The minimum amount of experience after modification is 1.""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            """UPDATE characters SET experience = ? WHERE character_name = ? AND player_id = ? AND guild_id = ?""",
            [
                experience,
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated {character["character_name"]}'s experience total to {experience}.""",
            fields=None,
            footer_text="""Their level and tier will update with the character's next valid message.""",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
        return
    ...
    async def min_wiggle(ctx, inter, min_wiggle, source):
        ...
        if min_wiggle < 0.01:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Minimum wiggle is too low!",
                fields=None,
                footer_text="The minimum minimum wiggle is 0.01.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        if min_wiggle > 5.00:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Minimum wiggle is too high!",
                fields=None,
                footer_text="The maximum minimum wiggle is 0.01.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET min_wiggle = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"Updated minimum wiggle to {min_wiggle}.",
            fields=None,
            footer_text=f"""Experience per message will be multiplied by between {min_wiggle} and \
{server_config["max_wiggle"]}. If both wiggles are 1, there is no wiggle.""",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
    ...
    async def minimum_length(ctx, inter, minimum_length, source):
        ...
        if minimum_length < 1:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Minimum length is too low!",
                fields=None,
        ...
        if minimum_length > 2000:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Minimum length is too high!",
                fields=None,
                footer_text="""Please select a minimum length that is less than the (non-Nitro) maximum number of \
characters permitted per message.""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET minimum_length = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated minimum length to {minimum_length}.""",
            fields=None,
            footer_text="The maximum that a minimum length can be is 2000.",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
    ...
    async def ooc_end(ctx, inter, ooc_end, source):
        ...
        if len(ooc_end) > 3:
            await EmbedBuilder.embed_builder(
                ...
                fields=None,
                footer_text="""For optimal play, please choose a string that is less than or equal to 3 characters \
long, including spaces.""",
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET ooc_end = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated the end of OOC messages to be denoted as {ooc_end}.""",
            fields=None,
            footer_text="""Please note that this feature only works if both ooc_start AND ooc_end are set.""",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
...
long, including spaces.""",
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET ooc_start = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated the start of OOC messages to be denoted as {ooc_start}.""",
            fields=None,
            footer_text="""Please note that this feature only works if both ooc_start AND ooc_end are set.""",
            status="success",
        )
...
characters.""",
        ...
        if multiplier < 0.01:
            await EmbedBuilder.embed_builder(
                ...
                description="Multiplier is too low!",
                fields=None,
                footer_text="The minimum supported role multiplier is 0.01.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        if multiplier > 10.00:
            await EmbedBuilder.embed_builder(
                ...
                description="Multiplier is too high!",
                fields=None,
                footer_text="The maximum supported role multiplier is 10.00.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT role_multipliers FROM server_config WHERE guild_id = ?",
            [src.guild.id],
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        ...
        multipliers = json.dumps(multipliers, indent=2)
        cur.execute(
            "UPDATE server_config SET role_multipliers = ? WHERE guild_id = ?",
            [multipliers, src.guild.id],
        )
        con.commit()
        con.close()
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated the experience multiplier for {role.name} to {multiplier}.""",
            fields=None,
    ...
    async def starting_level(ctx, inter, starting_level, source):
        ...
        if starting_level < 1:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Starting level is too low!",
                fields=None,
                footer_text="The minimum starting level is 1.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        if starting_level > int(server_config["maximum_level"]):
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Starting level is too high!",
                fields=None,
                footer_text=f"""Please choose a starting level less than this server's maximum level \
({server_config["maximum_level"]}).""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET starting_level = ? WHERE guild_id = ?",
        ...
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""The starting level has been updated to {starting_level}.""",
            fields=None,
            footer_text=f"""Players will start with {starting_experience} experience and in tier {starting_tier}.""",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
    ...
    async def tier_threshold(ctx, inter, tier, level, source):
        ...
        if tier < 1:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Tier is too low!",
                fields=None,
                footer_text="The minimum supported tier is 1.",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
            return
        ...
        cur = con.cursor()
        cur.execute(
            "SELECT maximum_level FROM server_config WHERE guild_id = ?", [src.guild.id]
        )
        server_config = [dict(value) for value in cur.fetchall()][0]
        con.close()
        if level > int(server_config["maximum_level"]):
            await EmbedBuilder.embed_builder(
                ...
                fields=None,
                footer_text=f"""The threshold you are attempting to set exceeds the maximum level for this server \
({server_config["maximum_level"]}).""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
        ...
        if level < int(server_config["maximum_level"]):
            if level >= int(thresholds[f"{tier + 1}"]):
                await EmbedBuilder.embed_builder(
                    ...
                    custom_thumbnail=None,
                    custom_title=None,
                    description="""Level threshold is too high!""",
                    fields=None,
                    footer_text=f"""The threshold for tier {tier + 1} is {thresholds[f"{tier + 1}"]}.""",
                    status="alert",
                )
                return
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET tier_thresholds = ? WHERE guild_id = ?",
            [thresholds, src.guild.id],
        )
        con.commit()
        con.close()
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""Updated the level threshold for tier {tier} to {level}.""",
            fields=None,
            footer_text=f"Players now need to be at least level {level} experience to hit tier {tier}.",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
    ...
    async def time_between(ctx, inter, time_between, source):
        ...
        if time_between < 30:  # This is to help mitigate load on the database. I think.
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Time between is too low!",
                fields=None,
                footer_text="""The maximum supported length between experience-rewarding messages is 30 seconds.""",
                status="alert",
            )
            return
        if time_between > 3600:
            await EmbedBuilder.embed_builder(
                ...
                custom_thumbnail=None,
                custom_title=None,
                description="Time between is too high!",
                fields=None,
                footer_text="""The maximum supported length between experience-rewarding messages is 3600 seconds \
(1 hour).""",
                status="alert",
            )
            await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
        ...
        cur = con.cursor()
        cur.execute(
            "UPDATE server_config SET time_between = ? WHERE guild_id = ?",
            [time_between, src.guild.id],
        )
        con.commit()
        con.close()
        await EmbedBuilder.embed_builder(
            ...
            custom_thumbnail=None,
            custom_title=None,
            description=f"""The time between experience-rewarding messages to {time_between} seconds.""",
            fields=None,
            footer_text="""The maximum length of time between experience-rewarding messages is 3600 seconds (1 \
hour).""",
            status="success",
        )
        await response.edit(content=None, embed=EmbedBuilder.embed, view=None)
...
per message.""",
    ...
    async def base_percentage_slash(self, inter, base_percentage: float):
        ...
        """
        await self.base_percentage(
            ctx=None, inter=inter, base_percentage=base_percentage, source="slash"
        )

    @commands.group(
        aliases=["percent"],
        brief="Set base percentage granted.",
        help="Sets the base percentage of experience needed for the next level to grant per message.",
        name="base_percentage",
        usage="base_percentage <#>",
    )
    @commands.guild_only()
    async def base_percentage_message(self, ctx, base_percentage: float):
        await self.base_percentage(
            ctx=ctx, inter=None, base_percentage=base_percentage, source="message"
        )
    ...
    @commands.guild_only()
    @commands.default_member_permissions(manage_guild=True)
    async def channel_multiplier_slash(
        self, inter, channel: disnake.TextChannel, multiplier: float
    ):
        """
        Parameters
        ----------
    ...
    @commands.group(
        aliases=["chan_mult"],
        brief="Sets multiplier in channel.",
        help="Sets the experience multiplier for the specified channel.",
        name="channel_multiplier",
        usage="channel_multiplier <channel.Mention> <#>",
    )
    @commands.guild_only()
    async def channel_multiplier_message(
        self, ctx, channel: disnake.TextChannel, multiplier: float
    ):
        await self.channel_multiplier(
            ctx=ctx,
            inter=None,
    ...
    @commands.slash_command(
        ...
        description="Sets the server-wide character limit.",
        dm_permission=False,
    )
    @commands.guild_only()
    @commands.default_member_permissions(manage_guild=True)
    async def character_limit_slash(self, inter, character_limit: int):
        ...
        """
        await self.character_limit(
            ctx=None, inter=inter, character_limit=character_limit, source="slash"
        )

    @commands.group(
        aliases=["limit"],
        brief="Set character limit.",
        help="Sets the server-wide character limit.",
        name="character_limit",
    ...
    async def character_limit_message(self, ctx, character_limit: int):
        await self.character_limit(
            ctx=ctx, inter=None, character_limit=character_limit, source="message"
        )
    ...
    @commands.slash_command(
        name="dm_role", description="Sets a role to be a DM role.", dm_permission=False
    )
    @commands.guild_only()
    @commands.default_member_permissions(manage_guild=True)
    ...
    @commands.group(
        aliases=["dmr"],
        brief="Sets a DM role.",
        help="Sets a role to be a DM role.",
        name="dm_role",
        usage="dm_role <role.Mention>",
    )
    @commands.guild_only()
    ...
    async def experience_threshold_slash(self, inter, level: int, experience: int):
        ...
        await self.experience_threshold(
            ctx=None, inter=inter, level=level, experience=experience, source="slash"
        )

    @commands.group(
        aliases=["xp_thresh"],
        brief="Sets experience for level.",
        help="Sets the amount of experience required to reach the specified level.",
        name="experience_threshold",
        usage="experience_threshold <#> <#>",
    )
    @commands.guild_only()
    ...
    async def ignore_channel_slash(self, inter, channel: disnake.TextChannel):
        ...
        await self.ignore_channel(
            ctx=None, inter=inter, channel=channel, source="slash"
        )

    @commands.group(
        aliases=["x_chan"],
        brief="No experience from channel.",
    ...
    @commands.group(
        aliases=["l_chan"],
        brief="Level-ups in channel.",
        help="Sets a channel to be where level-up messages are sent.",
        name="level_channel",
        usage="level_channel <channel.Mention>",
    )
    @commands.guild_only()
    ...
    @commands.group(
        aliases=["l_mess"],
        brief="Level-ups message.",
        help="Sets the message sent on level-up.",
        name="level_message",
        usage="level_message <message>",
    )
    @commands.guild_only()
    ...
    async def level_multiplier_slash(self, inter, level: int, multiplier: float):
        ...
        multiplier: Decimal up to hundredths. Min.: 0.01. Max.: 10.00.
        """
        await self.level_multiplier(
            ctx=None, inter=inter, level=level, multiplier=multiplier, source="slash"
        )

    @commands.group(
        aliases=["lv_mult"],
        brief="Sets multiplier at level.",
        help="Sets the experience multiplier for the specified level.",
        name="level_multiplier",
        usage="level_multiplier <#> <#>",
    )
    @commands.guild_only()
    async def level_multiplier_message(self, ctx, level: int, multiplier: float):
        await self.level_multiplier(
            ctx=ctx, inter=None, level=level, multiplier=multiplier, source="message"
        )
    ...
    async def max_wiggle_slash(self, inter, max_wiggle: float):
        ...
        """
        await self.max_wiggle(
            ctx=None, inter=inter, max_wiggle=max_wiggle, source="slash"
        )

    @commands.group(
        aliases=["max_wig"],
        brief="Set maximum random multiplier.",
    ...
    async def max_wiggle_message(self, ctx, max_wiggle: float):
        await self.max_wiggle(
            ctx=ctx, inter=None, max_wiggle=max_wiggle, source="message"
        )

    @commands.slash_command(
        name="maximum_level",
        description="Sets the maximum level on the server.",
        dm_permission=False,
    )
    @commands.guild_only()
    @commands.default_member_permissions(manage_guild=True)
    async def maximum_level_slash(self, inter, maximum_level: int):
        ...
        """
        await self.maximum_level(
            ctx=None, inter=inter, maximum_level=maximum_level, source="slash"
        )

    @commands.group(
        aliases=["max"],
        brief="Sets maximum level.",
        help="Sets the maximum level on the server.",
        name="maximum_level",
        usage="maximum_level <#>",
    )
    @commands.guild_only()
    async def maximum_level_message(self, ctx, maximum_level: int):
        await self.maximum_level(
            ctx=ctx, inter=None, maximum_level=maximum_level, source="message"
        )
    ...
    async def min_wiggle_slash(self, inter, min_wiggle: float):
        ...
        """
        await self.min_wiggle(
            ctx=None, inter=inter, min_wiggle=min_wiggle, source="slash"
        )

    @commands.group(
        aliases=["min_wig"],
        brief="Set minimum random multiplier.",
    ...
    async def min_wiggle_message(self, ctx, min_wiggle: float):
        await self.min_wiggle(
            ctx=ctx, inter=None, min_wiggle=min_wiggle, source="message"
        )
    ...
    async def minimum_length_slash(self, inter, minimum_length: int):
        ...
        """
        await self.minimum_length(
            ctx=None, inter=inter, minimum_length=minimum_length, source="slash"
        )

    @commands.group(
        aliases=["min"],
        brief="Set minimum length.",
        help="Sets the minimum length a message must be to gain experience.",
        name="minimum_length",
    ...
    async def minimum_length_message(self, ctx, minimum_length: int):
        await self.minimum_length(
            ctx=ctx, inter=None, minimum_length=minimum_length, source="message"
        )
    ...
    @commands.guild_only()
    @commands.default_member_permissions(manage_guild=True)
    async def mod_experience_slash(
        self,
        inter,
    ...
    @commands.group(
        aliases=["mod"],
        brief="Modify experience.",
        help="Modifies a character's experience by a specified amount.",
        name="mod_experience",
        usage="mod_experience <character> <+/-/=> <#>",
    )
    @commands.guild_only()
    async def mod_experience_message(
        self,
        ctx,
        player: disnake.Member,
        character_name: str,
    ...
    @commands.slash_command(
        name="ooc_end",
        description="Denotes the end of OOC messages.",
        dm_permission=False,
    )
    @commands.guild_only()
    @commands.default_member_permissions(manage_guild=True)
    ...
    @commands.group(
        aliases=["o_end"],
        brief="Denotes end of OOC.",
        help="Denotes the end of OOC messages.",
        name="ooc_end",
        usage="ooc_end <string>",
    )
    @commands.guild_only()
    ...
    @commands.slash_command(
        name="ooc_start",
        description="Denotes the start of OOC messages.",
        dm_permission=False,
    )
    @commands.guild_only()
    @commands.default_member_permissions(manage_guild=True)
    ...
    @commands.group(
        aliases=["o_start"],
        brief="Denotes start of OOC.",
        help="Denotes the start of OOC messages.",
        name="ooc_start",
        usage="ooc_start <string>",
    )
    @commands.guild_only()
    ...
    async def role_multiplier_slash(self, inter, role: disnake.Role, multiplier: float):
        ...
        multiplier: Decimal up to hundredths. Min.: 0.01. Max.: 10.00.
        """
        await self.role_multiplier(
            ctx=None, inter=inter, role=role, multiplier=multiplier, source="slash"
        )

    @commands.group(
        aliases=["role_mult"],
        brief="Sets multiplier for role.",
        help="Sets the experience multiplier for the specified role.",
        name="role_multiplier",
        usage="role_multiplier <role.Mention> <#>",
    )
    @commands.guild_only()
    async def role_multiplier_message(self, ctx, role: disnake.Role, multiplier: float):
        await self.role_multiplier(
            ctx=ctx, inter=None, role=role, multiplier=multiplier, source="message"
        )
    ...
    async def starting_level_slash(self, inter, starting_level: int):
        ...
        """
        await self.starting_level(
            ctx=None, inter=inter, starting_level=starting_level, source="slash"
        )

    @commands.group(
        aliases=["start"],
        brief="Sets starting level.",
        help="Sets the level that newly initialized characters will start at.",
        name="starting_level",
    ...
    async def starting_level_message(self, ctx, starting_level: int):
        await self.starting_level(
            ctx=ctx, inter=None, starting_level=starting_level, source="message"
        )
    ...
    async def tier_threshold_slash(self, inter, tier: int, level: int):
        ...
        """
        await self.tier_threshold(
            ctx=None, inter=inter, tier=tier, level=level, source="slash"
        )

    @commands.group(
        aliases=["tier_thresh"],
        brief="Sets level for tier.",
        help="Sets the level required to reach the specified tier.",
        name="tier_threshold",
    ...
    async def tier_threshold_message(self, ctx, tier: int, level: int):
        await self.tier_threshold(
            ctx=ctx, inter=None, tier=tier, level=level, source="message"
        )
    ...
    async def time_between_slash(self, inter, time_between: int):
        ...
        """
        await self.time_between(
            ctx=None, inter=inter, time_between=time_between, source="slash"
        )

    @commands.group(
        aliases=["time"],
        brief="Sets seconds between messages.",
        help="Sets the time (in seconds) between experience-rewarding messages.",
        name="time_between",
        usage="time_between <#>",
    )
    @commands.guild_only()
    async def time_between_message(self, ctx, time_between: int):
        await self.time_between(
            ctx=ctx, inter=None, time_between=time_between, source="message"
        )
