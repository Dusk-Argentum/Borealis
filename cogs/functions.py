...
class EmbedBuilder(disnake.Embed):
    ...
    async def embed_builder(
        ...
        add_success_thumbnail = (
            "https://bg3.wiki/w/images/thumb/1/14/Bless.webp/380px-Bless.webp.png"
        )
        ...
        failure_thumbnail = (
            "https://bg3.wiki/w/images/thumb/c/c4/Harm.webp/380px-Harm.webp.png"
        )
        failure_title = "Oops!"
        success_color = disnake.Color(0x023D08)  # Dark green
        success_thumbnail = (
            "https://bg3.wiki/w/images/thumb/3/36/Heal.webp/380px-Heal.webp.png"
        )
        success_title = "Cool!"
        ...
        waiting_thumbnail = (
            "https://bg3.wiki/w/images/thumb/5/5f/Slow.webp/380px-Slow.webp.png"
        )
        waiting_title = "Hm..."
        ...
        embed.set_footer(
            icon_url=ctx.guild.icon.url, text=f"{footer_text} | {ctx.guild.name}"
        )
